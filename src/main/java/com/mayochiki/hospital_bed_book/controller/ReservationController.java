...
public class ReservationController {
    ...
    public ResponseEntity<?> createReservation(@RequestBody Reservation reservation) {
        // Check if admissionDate was provided and is not in the past
        if (reservation.getAdmissionDate() == null) {
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Admission date is required.");
        }
